...
namespace count_chars
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // string data = "abcabda";
            string data = "blue boy, worried bout the worlds eyes worried, every time the sun shines worried about his haircut calm down, sweetheart grow up blue boy blue boy blue boy blue boy blue boy, older than the world knows honey, thats the way that life goes no use, acting so tough calm down sweetheart grow up blue boy blue boy blue boy blue boy hey tony";
            ...
            char LowestRepeatedChar = 'k';
            int LowestRepeatedCount = 1;
            ...
            System.Console.WriteLine($"Lowest Count: {LowestRepeatedChar} -> {LowestRepeatedCount}");
